        ...
        <div className="p-6 overflow-auto max-h-[calc(80vh-72px)]">
          ...
          <div className="mb-8 animate-in slide-in-from-bottom-3 duration-500">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-[#e6a2ce] text-lg font-medium">Rejaka Abimanyu Susanto</h3>
                <p className="text-sm text-[#f5eaf4] opacity-80">
                  {activeUser === "rez3x" ? "Full Stack Developer" : 
                   activeUser === "abim" ? "Academic Researcher" : "Creative Author"}
                </p>
              </div>
            </div>
            <p className="text-[#f5eaf4] leading-relaxed mb-4">
              Welcome to the portfolio of Rejaka Abimanyu Susanto. As a passionate technology professional based in Indonesia,
              I combine technical expertise with creative problem-solving to deliver exceptional digital experiences.
            </p>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 text-xs bg-[#3a2939] text-[#e6a2ce] rounded-full">Web Development</span>
              <span className="px-3 py-1 text-xs bg-[#3a2939] text-[#e6a2ce] rounded-full">Next.js</span>
              <span className="px-3 py-1 text-xs bg-[#3a2939] text-[#e6a2ce] rounded-full">TypeScript</span>
            </div>
          ...
          <div className="mt-10 pt-6 border-t border-[#5d4a5c] animate-in slide-in-from-bottom-3 duration-500" style={{ animationDelay: "500ms" }}>
            <h3 className="text-[#e6a2ce] text-lg font-medium mb-4 flex items-center">
              <span className="mr-2 text-sm">✦</span>
            ...
            <div className="space-y-4 pl-5">
              <p className="text-[#f5eaf4] leading-relaxed">
                ...
                creative writing, and academic research. Based in Indonesia, Rejaka combines analytical thinking with 
                creative problem-solving to develop innovative digital solutions and compelling content.
              </p>
              
              <p className="text-[#f5eaf4] leading-relaxed">
                As the creator of <a href="https://rejaka.me" className="text-[#e6a2ce] hover:underline">rejaka.me</a>, 
                Rejaka Abimanyu Susanto showcases a portfolio of web development projects, including 
                <a href="https://idea.rejaka.me" className="text-[#e6a2ce] hover:underline ml-1">idea.rejaka.me</a> and
                <a href="https://tasistemporary.rejaka.me" className="text-[#e6a2ce] hover:underline ml-1">tasistemporary.rejaka.me</a>.
              </p>
              
              <p className="text-[#f5eaf4] leading-relaxed">
                Connect with Rejaka Abimanyu Susanto on 
                <a href="https://github.com/REZ3X" target="_blank" rel="noopener noreferrer" className="text-[#e6a2ce] hover:underline mx-1">GitHub</a>,
                <a href="https://linkedin.com/in/rejaka-me" target="_blank" rel="noopener noreferrer" className="text-[#e6a2ce] hover:underline mx-1">LinkedIn</a>, or
                <a href="https://instagram.com/rejakasusanto" target="_blank" rel="noopener noreferrer" className="text-[#e6a2ce] hover:underline mx-1">Instagram</a>
