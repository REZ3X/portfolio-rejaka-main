...
export const experienceData: ExperienceDataType = {
  ...
  experience: [
    ...
    },
    {
      ...
      responsibilities: [
        "Led a team building web applications using Next.js and MongoDB",
        "Developed API routes and data modeling for scalable systems",
        "Reviewed peers’ code to maintain quality and best practices",
        "Coordinated deployment, CI/CD setup, and release planning",
      ],
      technologies: ["Next.js", "React", "MongoDB", "TypeScript", "API Routes"],
    },
    {
