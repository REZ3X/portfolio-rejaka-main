...
export const usersData: Record<UserAlias, UserData> = {
  rez3x: {
    ...
    alias: "rez3x",
    profileImage: "/assets/images/profile/rez3x.webp", // Update with actual path
  ...
  abim: {
    fullName: "Rejaka Abimanyu Susanto",
    alias: "abim",
    profileImage: "/assets/images/profile/abim.jpeg", // Update with actual path
  ...
  xiannyaa: {
    fullName: "Rejaka Abimanyu Susanto",
    alias: "xiannyaa",
    profileImage: "/assets/images/profile/xianyaa.jpg", // Update with actual path
